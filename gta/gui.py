...
import bpy
import os
from . import dff_importer, dff_exporter, col_importer, col_exporter
...
class DFF_MT_ExportChoice(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        self.layout.operator(EXPORT_OT_col.bl_idname, text="DragonFF Collision (.col)")
...
class DFFMaterialProps(bpy.types.PropertyGroup):
    ...
    preset_mat_cols : bpy.props.EnumProperty(
        ...
        (
            ...
            ("[255, 0, 255, 255]", "Quaternary Color", ""),
            ("[0, 255, 255, 255]", "Tertiary Color", ""),
